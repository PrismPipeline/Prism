...
class Ui_wg_Playblast(object):
    ...
    def retranslateUi(self, wg_Playblast):
        ...
        self.chb_globalRange.setText(QtWidgets.QApplication.translate("wg_Playblast", "global", None, -1))
        self.l_rangeEnd.setText(QtWidgets.QApplication.translate("wg_Playblast", "to:", None, -1))
