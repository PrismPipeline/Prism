...
class sgPublish(QDialog, ShotgunPublish_ui.Ui_dlg_sgPublish):
	def __init__(self, core, origin, ptype, shotName, task, version, sources, startFrame):
		...
		self.core.plugin.shotgunPublish_startup(self)
	...
	def updateTasks(self, idx=None):
		...
		if self.cb_shot.currentText() == "":
			QMessageBox.warning(self.core.messageParent, "Shotgun Publish", "No %s exists in the Shotgun project." % self.ptype )
			return
		...
		if self.ptype == "Asset":
			taskPaths.append(os.path.join(self.core.projectPath, sceneDir, "Assets", self.shotList[self.cb_shot.currentText()], "Rendering", "3dRender"))
			taskPaths.append(os.path.join(self.core.projectPath, sceneDir, "Assets", self.shotList[self.cb_shot.currentText()], "Rendering", "2dRender"))
			taskPaths.append(os.path.join(self.core.projectPath, sceneDir, "Assets", self.shotList[self.cb_shot.currentText()], "Rendering", "external"))
			taskPaths.append(os.path.join(self.core.projectPath, sceneDir, "Assets", self.shotList[self.cb_shot.currentText()], "Playblasts"))
		elif self.ptype == "Shot":
			shotPath = os.path.join(self.core.projectPath, sceneDir, "Shots")
			taskPaths.append(os.path.join(shotPath, self.cb_shot.currentText(), "Rendering", "3dRender"))
			taskPaths.append(os.path.join(shotPath, self.cb_shot.currentText(), "Rendering", "2dRender"))
			taskPaths.append(os.path.join(shotPath, self.cb_shot.currentText(), "Rendering", "external"))
			taskPaths.append(os.path.join(shotPath, self.cb_shot.currentText(), "Playblasts"))
