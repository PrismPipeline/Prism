...
class Ui_wg_Export(object):
    def setupUi(self, wg_Export):
        ...
        self.f_status = QtWidgets.QWidget(self.gb_export)
        ...
        self.f_connect = QtWidgets.QWidget(self.gb_export)
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(self.gb_export)
    ...
    def retranslateUi(self, wg_Export):
        ...
        self.groupBox_2.setTitle(QtWidgets.QApplication.translate("wg_Export", "Export Settings", None, -1))
