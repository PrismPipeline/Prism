...
class Prism_Photoshop_Functions(object):
	...
	def startup(self, origin):
		...
		with (open(os.path.join(os.getenv('LocalAppdata'), "Prism", "Plugins", "Photoshop", "UserInterfaces", "PhotoshopStyleSheet", "Photoshop.qss"), "r")) as ssFile:
		    ssheet = ssFile.read()

		ssheet = ssheet.replace("qss:", os.path.join(os.getenv('LocalAppdata'), "Prism", "Plugins", "Photoshop", "UserInterfaces", "PhotoshopStyleSheet").replace("\\", "/") + "/")
		...
		appIcon = QIcon(os.path.join(os.getenv('LocalAppdata'), "Prism", "Scripts", "UserInterfacesPrism", "p_tray.png"))
