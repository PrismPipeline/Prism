...
#
# Created: Sun Aug 12 21:05:59 2018
...
class Ui_dlg_PrismSettings(object):
    def setupUi(self, dlg_PrismSettings):
        ...
        self.gb_sgUser = QtGui.QGroupBox(self.tabWidgetPage1)
        self.gb_sgUser.setCheckable(True)
        self.gb_sgUser.setChecked(False)
        self.gb_sgUser.setObjectName("gb_sgUser")
        self.gridLayout_5 = QtGui.QGridLayout(self.gb_sgUser)
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.label_8 = QtGui.QLabel(self.gb_sgUser)
        self.label_8.setObjectName("label_8")
        self.gridLayout_5.addWidget(self.label_8, 0, 0, 1, 1)
        self.e_sgUsername = QtGui.QLineEdit(self.gb_sgUser)
        self.e_sgUsername.setObjectName("e_sgUsername")
        self.gridLayout_5.addWidget(self.e_sgUsername, 0, 1, 1, 1)
        self.label_9 = QtGui.QLabel(self.gb_sgUser)
        self.label_9.setObjectName("label_9")
        self.gridLayout_5.addWidget(self.label_9, 1, 0, 1, 1)
        self.e_sgUserPassword = QtGui.QLineEdit(self.gb_sgUser)
        self.e_sgUserPassword.setObjectName("e_sgUserPassword")
        self.gridLayout_5.addWidget(self.e_sgUserPassword, 1, 1, 1, 1)
        self.verticalLayout_7.addWidget(self.gb_sgUser)
        ...
        self.gb_curPshotgun = QtGui.QGroupBox(self.w_prjSettings)
        self.gb_curPshotgun.setCheckable(True)
        self.gb_curPshotgun.setChecked(False)
        self.gb_curPshotgun.setObjectName("gb_curPshotgun")
        self.verticalLayout_12 = QtGui.QVBoxLayout(self.gb_curPshotgun)
        self.verticalLayout_12.setObjectName("verticalLayout_12")
        self.w_shotgun = QtGui.QWidget(self.gb_curPshotgun)
        self.w_shotgun.setObjectName("w_shotgun")
        self.gridLayout_3 = QtGui.QGridLayout(self.w_shotgun)
        self.gridLayout_3.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_3.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.e_curPsgSite = QtGui.QLineEdit(self.w_shotgun)
        self.e_curPsgSite.setObjectName("e_curPsgSite")
        self.gridLayout_3.addWidget(self.e_curPsgSite, 0, 2, 1, 1)
        self.e_curPsgKey = QtGui.QLineEdit(self.w_shotgun)
        self.e_curPsgKey.setObjectName("e_curPsgKey")
        self.gridLayout_3.addWidget(self.e_curPsgKey, 3, 2, 1, 1)
        self.l_curPsgSite = QtGui.QLabel(self.w_shotgun)
        self.l_curPsgSite.setObjectName("l_curPsgSite")
        self.gridLayout_3.addWidget(self.l_curPsgSite, 0, 0, 1, 1)
        self.l_curPsgKey = QtGui.QLabel(self.w_shotgun)
        self.l_curPsgKey.setObjectName("l_curPsgKey")
        self.gridLayout_3.addWidget(self.l_curPsgKey, 3, 0, 1, 1)
        self.e_curPsgPrjName = QtGui.QLineEdit(self.w_shotgun)
        self.e_curPsgPrjName.setObjectName("e_curPsgPrjName")
        self.gridLayout_3.addWidget(self.e_curPsgPrjName, 1, 2, 1, 1)
        self.label_14 = QtGui.QLabel(self.w_shotgun)
        self.label_14.setObjectName("label_14")
        self.gridLayout_3.addWidget(self.label_14, 1, 0, 1, 1)
        self.e_curPsgScriptName = QtGui.QLineEdit(self.w_shotgun)
        self.e_curPsgScriptName.setObjectName("e_curPsgScriptName")
        self.gridLayout_3.addWidget(self.e_curPsgScriptName, 2, 2, 1, 1)
        self.label_15 = QtGui.QLabel(self.w_shotgun)
        self.label_15.setObjectName("label_15")
        self.gridLayout_3.addWidget(self.label_15, 2, 0, 1, 1)
        self.verticalLayout_12.addWidget(self.w_shotgun)
        self.verticalLayout_9.addWidget(self.gb_curPshotgun)
        ...
        dlg_PrismSettings.setTabOrder(self.e_lname, self.gb_sgUser)
        dlg_PrismSettings.setTabOrder(self.gb_sgUser, self.e_sgUsername)
        dlg_PrismSettings.setTabOrder(self.e_sgUsername, self.e_sgUserPassword)
        dlg_PrismSettings.setTabOrder(self.e_sgUserPassword, self.e_localPath)
        ...
        dlg_PrismSettings.setTabOrder(self.gb_curPversions, self.gb_curPshotgun)
        dlg_PrismSettings.setTabOrder(self.gb_curPshotgun, self.e_curPsgSite)
        dlg_PrismSettings.setTabOrder(self.e_curPsgSite, self.e_curPsgPrjName)
        dlg_PrismSettings.setTabOrder(self.e_curPsgPrjName, self.e_curPsgScriptName)
        dlg_PrismSettings.setTabOrder(self.e_curPsgScriptName, self.e_curPsgKey)
        dlg_PrismSettings.setTabOrder(self.e_curPsgKey, self.b_about)
    ...
    def retranslateUi(self, dlg_PrismSettings):
        ...
        self.gb_sgUser.setTitle(QtGui.QApplication.translate("dlg_PrismSettings", "Publish Shotgun versions with Shotgun account:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_8.setText(QtGui.QApplication.translate("dlg_PrismSettings", "Username:       ", None, QtGui.QApplication.UnicodeUTF8))
        self.label_9.setText(QtGui.QApplication.translate("dlg_PrismSettings", "Password:", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.gb_curPshotgun.setTitle(QtGui.QApplication.translate("dlg_PrismSettings", "Shotgun integration", None, QtGui.QApplication.UnicodeUTF8))
        self.l_curPsgSite.setText(QtGui.QApplication.translate("dlg_PrismSettings", "Shotgun site:", None, QtGui.QApplication.UnicodeUTF8))
        self.l_curPsgKey.setText(QtGui.QApplication.translate("dlg_PrismSettings", "Script API key:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_14.setText(QtGui.QApplication.translate("dlg_PrismSettings", "Project Name:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_15.setText(QtGui.QApplication.translate("dlg_PrismSettings", "Script Name:", None, QtGui.QApplication.UnicodeUTF8))
