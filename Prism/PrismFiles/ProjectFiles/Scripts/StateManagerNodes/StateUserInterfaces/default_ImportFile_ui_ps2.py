...
class Ui_wg_ImportFile(object):
    def setupUi(self, wg_ImportFile):
        ...
        self.f_curVersion = QtWidgets.QWidget(self.groupBox)
        self.f_curVersion.setObjectName("f_curVersion")
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout(self.f_curVersion)
        self.horizontalLayout_5.setContentsMargins(9, 0, 9, 0)
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.label_3 = QtWidgets.QLabel(self.f_curVersion)
        self.label_3.setObjectName("label_3")
        self.horizontalLayout_5.addWidget(self.label_3)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_5.addItem(spacerItem)
        self.l_curVersion = QtWidgets.QLabel(self.f_curVersion)
        ...
        self.f_lVersion = QtWidgets.QWidget(self.groupBox)
        self.f_lVersion.setObjectName("f_lVersion")
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout(self.f_lVersion)
        self.horizontalLayout_6.setContentsMargins(9, 0, 9, 0)
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.label_6 = QtWidgets.QLabel(self.f_lVersion)
        self.label_6.setObjectName("label_6")
        self.horizontalLayout_6.addWidget(self.label_6)
        spacerItem1 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_6.addItem(spacerItem1)
        self.l_latestVersion = QtWidgets.QLabel(self.f_lVersion)
        ...
        self.f_importLatest = QtWidgets.QWidget(self.groupBox)
        self.f_importLatest.setObjectName("f_importLatest")
        self.horizontalLayout_7 = QtWidgets.QHBoxLayout(self.f_importLatest)
        self.horizontalLayout_7.setContentsMargins(9, 0, 9, 0)
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        self.b_importLatest = QtWidgets.QPushButton(self.f_importLatest)
