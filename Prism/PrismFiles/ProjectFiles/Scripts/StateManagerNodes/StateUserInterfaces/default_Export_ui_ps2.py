...
class Ui_wg_Export(object):
    def setupUi(self, wg_Export):
        ...
        self.l_taskName2 = QtWidgets.QLabel(self.w_taskname)
        ...
        self.chb_globalRange = QtWidgets.QCheckBox(self.w_range)
        ...
        self.l_rangeStart = QtWidgets.QLabel(self.w_range)
        ...
        self.sp_rangeStart = QtWidgets.QSpinBox(self.w_range)
    ...
    def retranslateUi(self, wg_Export):
        ...
        self.l_taskName.setText(QtWidgets.QApplication.translate("wg_Export", "Taskname:", None, -1))
