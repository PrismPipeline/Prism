...
#
# Created: Tue Apr  4 15:18:02 2023
#      by: qtpy-uic 2.0.5
#
...
class Ui_dlg_CreateItem(object):
    ...
    def retranslateUi(self, dlg_CreateItem):
        dlg_CreateItem.setWindowTitle(QtWidgets.QApplication.translate("", "Create Category", None, -1))
        self.label.setText(QtWidgets.QApplication.translate("", "Type:", None, -1))
        self.rb_asset.setText(QtWidgets.QApplication.translate("", "Asset", None, -1))
        self.rb_folder.setText(QtWidgets.QApplication.translate("", "Folder", None, -1))
        self.l_item.setText(QtWidgets.QApplication.translate("", "Category Name:", None, -1))
        self.b_showTasks.setToolTip(QtWidgets.QApplication.translate("", "existing tasks", None, -1))
        self.b_showTasks.setText(QtWidgets.QApplication.translate("", "▼", None, -1))
