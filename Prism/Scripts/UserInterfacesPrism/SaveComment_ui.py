...
#
# Created: Wed Mar  8 17:41:18 2023
#      by: qtpy-uic 2.0.5
#
...
class Ui_dlg_SaveComment(object):
    ...
    def retranslateUi(self, dlg_SaveComment):
        dlg_SaveComment.setWindowTitle(QtWidgets.QApplication.translate("", "Save Extended", None, -1))
        self.l_preview.setText(QtWidgets.QApplication.translate("", "Preview", None, -1))
        self.label.setText(QtWidgets.QApplication.translate("", "Preview:", None, -1))
        self.l_comment.setText(QtWidgets.QApplication.translate("", "Comment:", None, -1))
        self.label_2.setText(QtWidgets.QApplication.translate("", "Description:", None, -1))
        self.b_changePreview.setText(QtWidgets.QApplication.translate("", "Change preview", None, -1))
