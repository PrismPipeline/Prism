...
class Ui_wg_ImportFile(object):
    def setupUi(self, wg_ImportFile):
        ...
        self.f_curVersion = QtGui.QWidget(self.groupBox)
        self.f_curVersion.setObjectName("f_curVersion")
        self.horizontalLayout_5 = QtGui.QHBoxLayout(self.f_curVersion)
        self.horizontalLayout_5.setContentsMargins(9, 0, 9, 0)
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.label_3 = QtGui.QLabel(self.f_curVersion)
        self.label_3.setObjectName("label_3")
        self.horizontalLayout_5.addWidget(self.label_3)
        spacerItem = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_5.addItem(spacerItem)
        self.l_curVersion = QtGui.QLabel(self.f_curVersion)
        self.l_curVersion.setObjectName("l_curVersion")
        self.horizontalLayout_5.addWidget(self.l_curVersion)
        self.verticalLayout_3.addWidget(self.f_curVersion)
        self.f_lVersion = QtGui.QWidget(self.groupBox)
        self.f_lVersion.setObjectName("f_lVersion")
        self.horizontalLayout_6 = QtGui.QHBoxLayout(self.f_lVersion)
        self.horizontalLayout_6.setContentsMargins(9, 0, 9, 0)
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.label_6 = QtGui.QLabel(self.f_lVersion)
        self.label_6.setObjectName("label_6")
        self.horizontalLayout_6.addWidget(self.label_6)
        spacerItem1 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_6.addItem(spacerItem1)
        self.l_latestVersion = QtGui.QLabel(self.f_lVersion)
        self.l_latestVersion.setObjectName("l_latestVersion")
        self.horizontalLayout_6.addWidget(self.l_latestVersion)
        self.verticalLayout_3.addWidget(self.f_lVersion)
        self.f_importLatest = QtGui.QWidget(self.groupBox)
        self.f_importLatest.setObjectName("f_importLatest")
        self.horizontalLayout_7 = QtGui.QHBoxLayout(self.f_importLatest)
        self.horizontalLayout_7.setContentsMargins(9, 0, 9, 0)
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        self.b_importLatest = QtGui.QPushButton(self.f_importLatest)
        ...
        self.verticalLayout_3.addWidget(self.f_importLatest)
