...
class Ui_wg_Folder(object):
    ...
    def retranslateUi(self, wg_Folder):
        wg_Folder.setWindowTitle(QtWidgets.QApplication.translate("wg_Folder", "Folder", None, -1))
        self.label_5.setText(QtWidgets.QApplication.translate("wg_Folder", "Name:", None, -1))
        self.l_class.setText(QtWidgets.QApplication.translate("wg_Folder", "Folder", None, -1))
