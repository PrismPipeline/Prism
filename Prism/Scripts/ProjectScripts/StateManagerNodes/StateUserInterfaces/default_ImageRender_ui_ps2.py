...
class Ui_wg_ImageRender(object):
    def setupUi(self, wg_ImageRender):
        ...
        self.f_range = QtWidgets.QWidget(self.groupBox)
        ...
        self.chb_globalRange = QtWidgets.QCheckBox(self.f_range)
        ...
        self.f_cam = QtWidgets.QWidget(self.groupBox)
        ...
        self.f_renderLayer = QtWidgets.QWidget(self.groupBox)
    ...
    def retranslateUi(self, wg_ImageRender):
        ...
        self.chb_globalRange.setText(QtWidgets.QApplication.translate("wg_ImageRender", "global", None, -1))
        self.l_rangeStart.setText(QtWidgets.QApplication.translate("wg_ImageRender", "from:", None, -1))
        self.l_rangeEnd.setText(QtWidgets.QApplication.translate("wg_ImageRender", "to:", None, -1))
