...
#
# Created: Mon Mar  6 23:25:55 2023
#      by: qtpy-uic 2.0.5
#
...
class Ui_wg_RenderSettings(object):
    ...
    def retranslateUi(self, wg_RenderSettings):
        wg_RenderSettings.setWindowTitle(QtWidgets.QApplication.translate("", "Render Settings", None, -1))
        self.l_name.setText(QtWidgets.QApplication.translate("", "Name:", None, -1))
        self.l_class.setText(QtWidgets.QApplication.translate("", "Render Settings", None, -1))
        self.gb_general.setTitle(QtWidgets.QApplication.translate("", "General", None, -1))
        self.chb_editSettings.setText(QtWidgets.QApplication.translate("", "Edit settings", None, -1))
        self.l_presetOption.setText(QtWidgets.QApplication.translate("", "Preset:", None, -1))
        self.b_loadCurrent.setText(QtWidgets.QApplication.translate("", "Get current settings", None, -1))
        self.b_loadPreset.setText(QtWidgets.QApplication.translate("", "Load preset...", None, -1))
        self.gb_settings.setTitle(QtWidgets.QApplication.translate("", "Settings", None, -1))
        self.b_resetSettings.setText(QtWidgets.QApplication.translate("", "Apply default settings", None, -1))
        self.b_applySettings.setText(QtWidgets.QApplication.translate("", "Apply preset", None, -1))
        self.b_savePreset.setText(QtWidgets.QApplication.translate("", "Save new preset...", None, -1))
